...
if (isset($_SERVER['HTTP_HOST'])) {
    ...
    // URL base por defecto si no se puede determinar dinámicamente
    $config['base_url'] = 'http://localhost/proyecto_3';
}
...
|
*/
$config['log_threshold'] = 4;  // Habilita todos los mensajes de log
/*
|--------------------------------------------------------------------------
...
|
*/
$config['log_path'] = '';  // Usa la ruta por defecto (application/logs/)
/*
|--------------------------------------------------------------------------
| Log File Extension
|--------------------------------------------------------------------------
