...
class Admin extends MY_Controller {
    ...
    public function dashboard() {
        try {
            ...
            // Cargar la vista del dashboard usando el layout
    ...
    public function usuarios() {
        try {
            ...
            $this->vista('admin/usuarios/index', $data);
    ...
    public function referencias() {
        try {
            ...
            $this->load->view('admin/referencias/index', $data);
    ...
    public function productos() {
        try {
            // Obtener productos con su referencia y estado
